...
<body>
    <div class="bg">
        <div class="box">
            <img src="https://media.discordapp.net/attachments/812342454820667443/872174384301879326/vcal-denied.png?width=468&height=468" alt="email" width="100px" height="100px" style="color: #00c49a;">
            <h1 class="heading">:(</h1>
            <p class="text">Your request for ${name} has been denied </p>
            <p class="text">Reason: ${reason}</p>
            <p class="text">Contact us at example@example.com if you think we have made a mistake</p>
