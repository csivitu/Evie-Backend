...
<body>
    <div class="bg">
        <div class="box">
            <img src="https://media.discordapp.net/attachments/812342454820667443/872137173384716298/Daco_287580.png?width=468&height=468"
                alt="email" width="100px" height="100px" style="color: #00c49a;">
            <h1 class="heading">Yay!</h1>
            <p class="text">Your request for ${name} has been approved and added to Evie</p>
